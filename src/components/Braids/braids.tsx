        ...
        <div className='container__hairneedling container__headspa container'>
            ...
            <div className='container__body__card'>
                ...
                <div className='container__hairneedling__body container__card__hairneedling'>
                    ...
                    {/* Image */}
                    <div className='body__card__side__background__image__braids body__card__side__background__image body__card__side__background container__body__card__hairneedling body__card__side body__card'>
                        {/* Photo */}
